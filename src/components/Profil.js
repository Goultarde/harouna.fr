...
const content = {
  fr: {
    ...
    p1:     "Etudiant en Mastere Cybersecurite, je me forme aux techniques offensives depuis deux ans. Passionne par la securite, j'explore les systemes via HackTheBox, des projets Red Team et du developpement d'outils offensifs.",
    p2:     "Je recherche une alternance en Pentest (1 semaine cours / 3 semaines entreprise) pour appliquer mes competences dans un contexte professionnel reel.",
    fbTitle: 'Identite',
    rows: [
      { dt: 'Statut',       dd: 'Etudiant en alternance' },
      { dt: 'Formation',    dd: 'Mastere Cybersecurite' },
      { dt: 'Lieu',         dd: 'France' },
